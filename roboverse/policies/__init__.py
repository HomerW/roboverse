from .pick_place import PickPlace, PickPlaceWrist, PickPlaceWristPush, PickPlaceOpen, PickPlaceOpenSuboptimal, PickPlacePush, Push
...
policies = dict(
    ...
    pickplacewrist=PickPlaceWrist,
    pickplacewristpush=PickPlaceWristPush,
)
