...
ENVIRONMENT_SPECS = (
    ...
    {
        'id': 'Widow250AffordanceTraining-v0',
        'entry_point': 'roboverse.envs.widow250_pickplace:Widow250PickPlacePositionMultiObjectEnv',
        'kwargs': {
            'reward_type': 'pick_place',
            'control_mode': 'discrete_gripper',
            ...
            'camera_yaw': 20,
            'camera_pitch': -50,
            'camera_target_pos': (0.62, 0.2, -0.33),
            # 'show_place_target': True
        }
    },
    {
    ...
    {
        'id': 'Widow250PickPlacePushPositionMultiObjectState-v0',
        'entry_point': 'roboverse.envs.widow250_pickplace:Widow250PickPlacePositionMultiObjectEnv',
        'kwargs': {
            'reward_type': 'pick_place',
            'control_mode': 'discrete_gripper',
            'observation_mode': 'robot_object_state',
            'observation_img_dim': 128,
            'possible_objects': PICK_PLACE_TRAIN_OBJECTS[:8] + PUSH_TRAIN_OBJECTS[:8],
            'num_objects': 3,
            'load_tray': True,
    ...
    {
        'id': 'Widow250DiversePickPlacePositionMultiObjectClutteredState-v0',
        'entry_point': 'roboverse.envs.widow250_pickplace:Widow250PickPlacePositionMultiObjectEnv',
        'kwargs': {
            'reward_type': 'pick_place',
            'control_mode': 'discrete_gripper',
    ...
    {
        'id': 'Widow250DiversePickPlacePositionMultiObjectState-v0',
        'entry_point': 'roboverse.envs.widow250_pickplace:Widow250PickPlacePositionMultiObjectEnv',
        'kwargs': {
            'reward_type': 'pick_place',
            'control_mode': 'discrete_gripper',
    ...
    {
        'id': 'Widow250DiversePickPlacePositionMultiObjectFixGripperState-v0',
        'entry_point': 'roboverse.envs.widow250_pickplace:Widow250PickPlacePositionMultiObjectEnv',
        'kwargs': {
            'reward_type': 'pick_place',
            'control_mode': 'discrete_gripper',
    ...
    {
        'id': 'Widow250DiversePickPlacePositionMultiObjectFixGripperFixObjQuatState-v0',
        'entry_point': 'roboverse.envs.widow250_pickplace:Widow250PickPlacePositionMultiObjectEnv',
        'kwargs': {
            'reward_type': 'pick_place',
            'control_mode': 'discrete_gripper',
